...
export default function Soutiens() {
  return (
    <section id="soutiens" className="bg-ardoise-50 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-ardoise-700">
            Depuis la naissance de Zaza Midôla, cette aventure humaine n’aurait pas été possible sans le soutien
            précieux de plusieurs personnes qui ont cru en ce projet dès ses débuts.
          </p>
        </Reveal>
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-3">
          {supporters.map((s, i) => (
            <Reveal key={s.name + i} delay={i * 0.1}>
              <div className="flex h-full flex-col items-center rounded-3xl border border-ardoise-900/5 bg-nacre p-8 text-center">
                ...
                <p className="mt-3 text-sm text-ardoise-700 text-justify">{s.bio}</p>
              </div>
            </Reveal>
          ))}
        </div>
